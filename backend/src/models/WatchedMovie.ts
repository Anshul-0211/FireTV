...
export class WatchedMovieModel {
  ...
  static async getUserWatchedMovies(userId: number, limit?: number, offset?: number): Promise<QueryResult<WatchedMovie[]>> {
    try {
  ...
  static async getWatchedStatus(userId: number, tmdbId: number): Promise<QueryResult<WatchedMovie | null>> {
    try {
      const client = await pool.connect();
  ...
  static async markAsWatched(
    userId: number, 
    watchedData: CreateWatchedMovieRequest
  ): Promise<QueryResult<WatchedMovie>> {
    try {
      const client = await pool.connect();
  ...
  static async updateWatchedMovie(
    userId: number, 
    tmdbId: number, 
    updateData: UpdateWatchedMovieRequest
  ): Promise<QueryResult<WatchedMovie>> {
    try {
  ...
  static async removeFromWatched(userId: number, tmdbId: number): Promise<QueryResult<boolean>> {
    try {
      const client = await pool.connect();
      const result = await client.query(
  ...
  static async getUserMovieStats(userId: number): Promise<QueryResult<any>> {
    try {
      const client = await pool.connect();
      const result = await client.query(`
        SELECT 
  ...
  static async getMoviesByRating(userId: number, rating: MovieRating): Promise<QueryResult<WatchedMovie[]>> {
    try {
      const client = await pool.connect();
      const result = await client.query(`
        SELECT id, user_id, movie_id, tmdb_id, title, watched_at, rating, current_mood, created_at, updated_at
  ...
  static async getMoviesByMood(userId: number, mood: MoodType): Promise<QueryResult<WatchedMovie[]>> {
    try {
      const client = await pool.connect();
      const result = await client.query(`
        SELECT id, user_id, movie_id, tmdb_id, title, watched_at, rating, current_mood, created_at, updated_at
  ...
  static async getAllWatchedMoviesWithUsers(limit?: number): Promise<QueryResult<any[]>> {
    try {
      const client = await pool.connect();
  ...
  static async getRecentlyWatchedMovies(limit: number = 10): Promise<QueryResult<any[]>> {
    try {
      const client = await pool.connect();
      const result = await client.query(`
        SELECT 
  ...
  static async deleteUserWatchedMovies(userId: number): Promise<QueryResult<boolean>> {
    try {
      const client = await pool.connect();
