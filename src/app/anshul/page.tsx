    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-black text-white">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-white drop-shadow-lg">Anshul's Fire TV</span>
        </div>
        ...
        {loading ? (
          ...
          >
            <CarouselContent className="h-full">
              {anshulHeroContent.map((movie, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center h-full p-4 md:p-6">
                      <div className="max-w-xl">
                        <Badge className="mb-2 bg-blue-600 hover:bg-blue-700 text-xs">
                          {movie.rating}
                        </Badge>
