    ...
    <div className="min-h-screen bg-black text-white flex flex-col relative">
      ...
      <header className="flex items-center justify-center py-8 border-b border-cyan-400/20">
        <div className="flex items-center space-x-3">
          <div className="w-20 h-20 bg-gradient-to-r from-orange-500 to-red-500  flex items-center justify-center">
            <svg className="w-64 h-64" fill="#000000" width="1000px" height="1000px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
